...
public final class Bootstrap {
    ...
    static {
        //z 初始化 Constants.CATALINA_BASE_PROP Constants.CATALINA_HOME_PROP两个变量
        //z 这俩变量就是tomcat根目录，只有使用同一份tomcatjar 部署多个tomcat时这俩变量才会不同
    ...
    public void init() throws Exception {
        //z 根据conf/catalina.properties 初始化 null,common,server,shared类加载器
        initClassLoaders();
        ...
        //z 初始化catalina 并把sharedLoader赋值给 catalina.parentClassLoader
